...
export default function ChooseCompanion() {
  ...
  return (
    <SafeAreaView style={styles.topLevel}>
      ...
      <ActionButton title="Confirm" onPress={onConfirm} style={[styles.confirmButton, selectedCompanion ? { opacity: 1 } : {opacity:0}]}></ActionButton>
    </SafeAreaView>
  )
}
